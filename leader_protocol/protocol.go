...
type CryptoSession struct {
	...
	mainSessionKey [gake.SsLen]byte     // The resulting main session key used for inter-cluster communication.
}
...
func (s *Session) GetMainSessionKeyRef() *[32]byte {
	return &s.crypto.mainSessionKey
}
...
func (s *Session) tryFinalizeProtocol() {
	...
	s.crypto.mainSessionKey = sharedSecret
	s.onMainSessionKey()
}
